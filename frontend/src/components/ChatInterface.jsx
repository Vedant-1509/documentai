...
// //           params: { companyName: user.businessName, question },
// //         });
// //       } else if (mode === 'crawl') {
// //         res = await axios.post('http://localhost:8080/api/crawl-and-ask', null, {
// //           params: { url, companyName: user.businessName, question },
// //         });
// //       } else if (mode === 'upload') {
...
// //   return (
// //     <div className="min-h-screen flex flex-col justify-between bg-gradient-to-br from-[#16082c] via-[#251143] to-[#321c5e] text-white px-4 py-6">
// //       {/* Header */}
// //       <div className="text-white text-sm bg-white/10 px-4 py-2 rounded-full w-fit mx-auto mb-6">
// //         Welcome, {user.name}
// //       </div>

// //       {/* Chat Messages */}
// //       <div className="flex flex-col flex-1 overflow-y-auto gap-4 px-2 space-y-4">
// //         {submittedQuestion && (
// //           <div className="w-full flex justify-end px-2">
// //             <div className="bg-[#dcf8c6] text-black px-4 py-2 rounded-t-xl rounded-bl-xl shadow-md max-w-[70%]">
// //               {submittedQuestion}
// //               <div className="text-xs text-right text-gray-600 mt-1">You</div>
// //             </div>
// //           </div>
// //         )}
...
// //             <div className="bg-white text-black px-4 py-2 rounded-t-xl rounded-br-xl shadow-md max-w-[70%]">
// //               {answer}
// //               <div className="text-xs text-right text-gray-600 mt-1">DocAI</div>
// //             </div>
// //           </div>
// //         )}
// //       </div>
...
// //           {mode === 'crawl' && (
// //             <input
// //               className="bg-white/10 p-2 rounded text-white placeholder-white/70"
// //               type="text"
...
// //                 type="submit"
// //                 disabled={loading}
// //                 className="px-4 text-lg text-white"
// //               >
// //                 ➤
// //               </button>
// //             </div>
...
// //         {/* Mode Selectors */}
// //         <div className="flex flex-col sm:flex-row flex-wrap justify-center gap-4 pt-6 border-t border-white/10 mt-6">
// //           <button
// //             className={`flex items-center gap-2 px-6 py-3 rounded-xl bg-gradient-to-r from-[#6b3ce9] to-[#9f53e0] hover:scale-105 transition ${
// //               mode === 'upload' ? 'ring-2 ring-white' : ''
// //             }`}
...
//   const handleLogout = () => {
//   localStorage.removeItem('token');
//   onLogout(); // tell App.js to clear user
//   navigate('/login');
// };
...
//       {/* Top Navbar */}
//       <div className="flex items-center justify-between px-6 py-4 border-b border-white/10 bg-[#1f1140]/80 shadow-md">
...
//       {/* Chat Messages */}
//       <div className="flex flex-col flex-1 overflow-y-auto gap-4 px-4 pt-6">
//         {submittedQuestion && (
//           <div className="w-full flex justify-end px-2">
//             <div className="bg-[#dcf8c6] text-black px-4 py-2 rounded-t-xl rounded-bl-xl shadow-md max-w-[70%]">
//               {submittedQuestion}
...
//       <div className="w-full max-w-2xl mx-auto space-y-4 mt-8 px-4 pb-8">
//         <form onSubmit={handleSubmit} className="flex flex-col gap-4">
//           {mode === 'crawl' && (
//             <input
//               className="bg-white/10 p-2 rounded text-white placeholder-white/70"
