...
export default function ChatInterface({ user, onLogout }) {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      if (mode === 'stored') {
        res = await axios.post('http://ec2-13-62-103-164.eu-north-1.compute.amazonaws.com:8080/api/ask', null, {
        ...
        res = await axios.post('http://ec2-13-62-103-164.eu-north-1.compute.amazonaws.com:8080/api/crawl-and-ask', null, {
        ...
        res = await axios.post('http://ec2-13-62-103-164.eu-north-1.compute.amazonaws.com:8080/api/ask-from-file', formData, {
